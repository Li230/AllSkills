---
description: 'opsx-flow Phase 1: 需求探索与质询。通过 grill-me 苏格拉底式提问挖透需求边界，产出需求范围说明并更新执行契约。触发词："探索需求"、"flow-explore"、"Phase
  1"。'
name: flow-explore
---

# Flow-Explore — Phase 1: 需求探索
...
## 下一步
read_file: skills/flow-proposal/SKILL.md
```
...
- [ ] 四维度质询已问用户并拿到回复
- [ ] 需求范围说明已整理
- [ ] _checkpoint.md 已更新（指向 flow-proposal）
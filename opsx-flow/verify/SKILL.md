---
name: opsx-verify
description: "opsx-flow Phase 5: 验证+换模型审查。结构验证（spec↔实现一致性）+ 换模型独立审查，防止自审走过场。触发词：\"验证\"、\"opsx-verify\"、\"Phase 5\"、\"审查\"。"
---

# Opsx-Verify — Phase 5: 验证与审查
...
## 下一步
read_file: skills/opsx-flow/archive/SKILL.md
```
...
- [ ] 换模型审查完成
- [ ] 必须修的意见已处理
- [ ] _checkpoint.md 已更新（指向 opsx-archive）

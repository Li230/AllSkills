---
name: opsx-plan
description: "opsx-flow Phase 3: 原子任务规划。产出 design.md（关键决策+风险）和 tasks.md（带类型标注的可验证原子任务）。触发词：\"拆任务\"、\"opsx-plan\"、\"Phase 3\"。"
---

# Opsx-Plan — Phase 3: 任务规划
...
## 下一步
read_file: skills/opsx-flow/apply/SKILL.md
```
...
- [ ] _checkpoint.md 已更新（指向 opsx-apply）

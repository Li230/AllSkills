---
name: opsx-apply
description: "opsx-flow Phase 4: 执行+调度。按 tasks.md 的类型标注调度对应 skill 执行，质量闸门兜底，每 3-5 任务更新执行契约。触发词：\"执行\"、\"opsx-apply\"、\"Phase 4\"。"
---

# Opsx-Apply — Phase 4: 执行与调度
...
```
确认 Phase 3 plan 已完成、tasks.md 已写。
...
## 全部完成后
read_file: skills/opsx-flow/verify/SKILL.md
```
...
- [ ] 每个任务有验证证据
- [ ] python 任务跑过 gate
- [ ] _checkpoint.md 标记 Phase 4 完成（指向 opsx-verify）

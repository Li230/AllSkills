---
description: 'opsx-flow Phase 2: 方案构建。必读 brainstorming skill 做设计思考，产出 proposal.md
  和 specs/ delta。触发词："写方案"、"flow-proposal"、"Phase 2"。'
name: flow-proposal
---

# Flow-Proposal — Phase 2: 方案构建
...
自查清单：
- 每个 capability 有对应 spec？
- 每个 spec 有 ADDED Requirements + Scenario？
- tasks 能覆盖所有 spec requirements？
- proposal/design/tasks 三者一致？
...
## 下一步
read_file: skills/flow-plan/SKILL.md
```
...
- [ ] specs/ delta 已写（如适用）
- [ ] spec self-review 完成
- [ ] _checkpoint.md 已更新（指向 flow-plan）